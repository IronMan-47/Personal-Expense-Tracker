...
Prerequisites
When I set up the machine I always check that Python 3.x is installed on my computer. You also need to make sure that Python 3.x is installed on your system. Do not skip this step.
...
First Run:
When the menu appears I click Option 1. Option 1 is the Add New Expense option.
